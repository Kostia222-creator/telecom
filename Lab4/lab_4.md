...
# Сделать копию файла Lab_№варианта.txt (например, copy_Lab_№варианта.txt ) в этом же каталоге и удалить его
...
![Этап 10](Nubber_10.PNG)

# Объединить все файлы, хранящиеся в каталоге Personal, в файл all.txt и вывести его содержимое на экран.

![Этап 11](Nubber_11.PNG)

# Отредактировать файл all.txt, добавив в него год вашего рождения, и вывести его содержимое на экран.

![Этап 12](Nubber_12.PNG)

# Скопировать файл all.txt в директорию А1.

![Этап 13](Nubber_13.PNG)

# Удалить все директории, в названии которых есть буква A или цифра 2.

![Этап 14](Nubber_14.PNG)
